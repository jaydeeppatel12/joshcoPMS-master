<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="addSupplierUser.ascx.cs" Inherits="joshcoWA.user.addSupplierUser" %>
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
   ...
   <table style="width:100%">
                                ...
                                <tr>
                                    <td style="width:180px;"> Add Select Service Provider</td><td style="width:300px;">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" BackColor="#FFFF99" ControlToValidate="txtPassword" Display="Dynamic" ErrorMessage="*Required" Font-Size="8pt" ForeColor="Red" ValidationGroup="AddP"></asp:RequiredFieldValidator>
...
At least 8 characters length"  
        ...
        BackColor="#FFFF99" Font-Size="8pt" ForeColor="Red" ValidationGroup="AddP" ControlToValidate="txtPassword"></asp:RegularExpressionValidator>
                                    ...
                                    <td style="vertical-align:top">
                                        <input runat="server"  class="form-control py-2 " pattern=".{8,12}" type="password"  placeholder="Password" id="txtPassword" />
                                    </td>
                                    <td>
                                        &nbsp;</td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    <td> 
                                     ...
                                     <asp:SqlDataSource ID="sdsUser" runat="server" ConnectionString="<%$ ConnectionStrings:joshcoCS %>" SelectCommand="SelectUser" InsertCommand="InsertUser" InsertCommandType="StoredProcedure" OnInserted="sdsUser_Inserted" UpdateCommand="UpdateUser" UpdateCommandType="StoredProcedure" SelectCommandType="StoredProcedure">
                                         ...
                                         <asp:SqlDataSource ID="sdsServiceProvider" runat="server" ConnectionString="<%$ ConnectionStrings:joshcoCS %>" SelectCommand="SelectServiceProviderUser" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                                    </td> 
