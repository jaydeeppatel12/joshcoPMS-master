<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="userProfile.ascx.cs" Inherits="joshcoWA.user.UserProfile" %>
...
ValidationExpression="[0-9]{10}"></asp:RegularExpressionValidator>
                                ...
                                <tr>
                                    <td>
                                        Change Password?</td><td>
                                        <asp:RadioButtonList ID="rblChangePassword" runat="server" RepeatDirection="Horizontal" AutoPostBack="True" OnSelectedIndexChanged="rblChangePassword_SelectedIndexChanged">
                                            <asp:ListItem Value="True">Yes</asp:ListItem>
                                            <asp:ListItem Value="False" Selected="True">No</asp:ListItem>
                                        </asp:RadioButtonList>
                                       <asp:DropDownList ID="ddlUserGroup" runat="server" AppendDataBoundItems="True" CssClass="btn-outline-warning btn-fw" DataSourceID="sdsUserGroup" DataTextField="UserGroup" DataValueField="UserGroupID" Enabled="False"  Visible="False">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        </span><asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtPassword" Display="Dynamic" ErrorMessage="*Required" Font-Size="8pt" ForeColor="Red" ValidationGroup="AddP" BackColor="#FFFF99" Enabled="False"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator 
                                            ID="RegularExpressionValidators2" 
                                            runat="server" 
                                            ErrorMessage="Password must have: At least one lower case letter, At least one upper case letter, At least special character, At least one number, At least 8 characters length"  
                                            ValidationExpression="^.*(?=.{8,})(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[!*@#$%^&+=]).*$"  
                                            BackColor="#FFFF99" 
                                            Font-Size="8pt" 
                                            ForeColor="Red" ValidationGroup="AddP" 
                                            ControlToValidate="txtPassword" 
                                            Display="Dynamic"></asp:RegularExpressionValidator>
                                    </td><td style="vertical-align:top; height:0px;">
                                        <%-- <input runat="server"  type="password" class="form-control py-2" pattern=".{8,12}" title="" placeholder="Password" id="txtPassword" enableviewstate="False" /></td> --%>
                                    <asp:TextBox runat="server"  type="password" class="form-control py-2" pattern=".{8,12}" title="" placeholder="Password" id="txtPassword" enableviewstate="False"></asp:TextBox>
                                    <td>
                                        </td> 
                                ...
                                <tr>
                                    <td>
                                        ...
                                        </span><asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtPassword" ControlToValidate="txtRePassword" ErrorMessage="*password not matching" Font-Size="8pt" ForeColor="Red" BackColor="#FFFF99" Display="Dynamic" ValidationGroup="AddP"></asp:CompareValidator>
                                ...
                                <tr>
                                    <td> 
                                     ...
                                     <asp:SqlDataSource ID="sdsUser" runat="server" ConnectionString="<%$ ConnectionStrings:joshcoCS %>" SelectCommand="SelectUser" InsertCommand="InsertUser" InsertCommandType="StoredProcedure" UpdateCommand="UpdateUser" UpdateCommandType="StoredProcedure" SelectCommandType="StoredProcedure">
                                         <InsertParameters>
                                     ...
                                     <asp:SqlDataSource ID="sdsUserPassword" runat="server" ConnectionString="<%$ ConnectionStrings:joshcoCS %>" SelectCommand="Select''" InsertCommand="InsertUser" InsertCommandType="StoredProcedure" UpdateCommand="Update dbo.[User] set UserPassword =@UserPassword Where UserID =@UserID">
                                         <InsertParameters>
                                             <asp:Parameter Name="UserFirstName" Type="String" />
                                             <asp:Parameter Name="UserSurname" Type="String" />
                                             <asp:Parameter Name="UserEmailAddress" Type="String" />
