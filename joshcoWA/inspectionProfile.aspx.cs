...
namespace joshcoWA
{
    public partial class inspectionProfile : System.Web.UI.Page
    {
        ...
        //        string PropertyInspectionID = Session["PropertyInspectionID"].ToString();

        //        SaveFile(name, contentType, size, fileData, "1", PropertyInspectionID);
        //    }
        //}
