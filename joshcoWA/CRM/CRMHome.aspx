<%@ Page Title="" Language="C#" MasterPageFile="CRM.Master" AutoEventWireup="true" CodeBehind="CRMHome.aspx.cs" Inherits="joshcoWA.CRM.CRMHome" %>
                                            ...
                                            <asp:Panel ID="pnlAdvancedSearch" runat="server">
                                                <div class="alert alert-success mt-4 d-flex align-items-center" role="alert">
                                                    <table style="width: 100%">
                                                        <tr>
                                                            <td style="width: 118px">Reference No.</td>
                                                            <td>
                                                            ...
                                                            <td style="vertical-align: top;">
                                                                <asp:Image ID="hlkCloseAdvancedSearch" runat="server" ImageUrl="../images/close.png" Width="10px" ToolTip="Close search" Style="float: right;" />
                                                            </td>
                                                        </tr>
                                                        <tr>
