<%@ Page Title="" Language="C#" MasterPageFile="CRM.Master" AutoEventWireup="true" CodeBehind="queryView.aspx.cs" Inherits="joshcoWA.CRM.queryView" %>
        ...
        <div style="padding:15px; width:100%;">
            <%--WHERE (([EndDate] &gt;= GetDate()) AND ([FacilityManagementStatusID] &lt;&gt; 3))--%>
                         ...
                         <table style="padding-bottom:10px; width:100%;">
                             <tr><td style="width: 20%"> Reference No</td>
                                 <td style="padding-bottom:8px">
                                     <asp:Label ID="lblReferenceNo" runat="server" ForeColor="#333333"></asp:Label></td>
                                 <td style="padding-bottom:8px; vertical-align:top;" class="auto-style1" rowspan="8"></td>
                             </tr>
                             <tr><td style="width: 20%"> Category</td><td style="padding-bottom:8px">
                                <asp:Label ID="lblQueryItem" runat="server" ForeColor="#333333"></asp:Label></td>
                             </tr>              
...
FROM [FacilityManagement] ">
            ...
            <div style="padding: 15px">
                                            <div class="form-row">
                                                ...
                                                <div class="col">
                                                    <asp:Button ID="Button1" CssClass="btn btn-warning" runat="server" Text="Add Comment" OnClick="btnSave_Click" ValidationGroup="AddP" />
...
Where QuotationID = @QuotationID" >
    ...
    <div class="body" style="padding:10px"> <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        ...
                                        <table class="nav-justified">
                                            <tr>
                                                <td>
                                                    <asp:DropDownList ID="ddlStatus1" runat="server"  CssClass="btn-outline-warning btn-fw" SelectedValue='<%# Eval("Awarded") %>'>
