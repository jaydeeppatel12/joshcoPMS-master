<%@ Page Title="" Language="C#" MasterPageFile="~/student/StudentAdmin.Master" AutoEventWireup="true" CodeBehind="studentAppProfile.aspx.cs" Inherits="joshcoWA.student.studentAppProfile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <section class="site-section">
    ...
    <h2>Student Application Form</h2>
      <asp:Image ID="imgback" ImageUrl="../images/back.png" runat="server" /><asp:HyperLink ID="hlnkBack" NavigateUrl="studentAppList.aspx" runat="server">Back</asp:HyperLink>
...
<div class="pop"  style="width:800px; padding:15px; margin-top:50px; "  >
    ...
    <div>
        <asp:Button Text="Applicant Details" BorderStyle="None" ID="Tab1" CssClass="Initial" runat="server"
              OnClick="Tab1_Click" />
          <asp:Button Text="Accommodation Details" BorderStyle="None" ID="Tab2" CssClass="Initial" runat="server"
              OnClick="Tab2_Click" />
          <asp:Button Text="Parent Details" BorderStyle="None" ID="Tab3" CssClass="Initial" runat="server"
              OnClick="Tab3_Click" />
                  <asp:Button Text="Financial Sponsor" BorderStyle="None" ID="Tab4" CssClass="Initial" runat="server"
              OnClick="Tab4_Click" />
                  <asp:Button Text="Student Declaration" BorderStyle="None" ID="Tab5" CssClass="Initial" runat="server"
              OnClick="Tab5_Click" />
          ...
          <asp:MultiView ID="MainView" runat="server">
            <asp:View ID="View1" runat="server">
              <table style="width: 100%; border-width: 1px; border-color: #666; border-style: solid">
                <tr>
                  <td>
                    <uc1:frmStudentApplicant runat="server" id="frmStudentApplicant" />                       
                  </td>
                </tr>
              </table>
            </asp:View>
            <asp:View ID="View2" runat="server">
              <table style="width: 100%; border-width: 1px; border-color: #666; border-style: solid">
                <tr>
                  <td>           
                     <uc1:frmStudentAccommodation runat="server" id="frmStudentAccommodation"  />                  
                  </td>
                </tr>
              </table>
            </asp:View>
            <asp:View ID="View3" runat="server">
              <table style="width: 100%; border-width: 1px; border-color: #666; border-style: solid">
                <tr>
                  <td>              
                    <uc1:frmStudentParent runat="server" id="frmStudentParent" />            
                  </td>
                </tr>
              </table>
            </asp:View>
            ...
            <tr>
                <td>                 
                    <uc1:frmStudentFinancialSponsor runat="server" id="frmStudentFinancialSponsor" />                 
                </td>
            </tr>
            </table>
        </asp:View>
            ...
            <tr>
              ...
              <uc1:frmStudentDeclaration runat="server" id="frmStudentDeclaration" />
...
<h3 class="heading">Application Review</h3>
                                     ...
                                     <table id="pnlStatus" runat="server" style="width: 100%">
                                          <tr>
                                              <td style="vertical-align:middle;width:65%">
                                                          <span style="color:red">*</span><asp:RequiredFieldValidator ID="rfvComment" runat="server" BackColor="#FFFF99" ControlToValidate="txtComment" ErrorMessage="Comment is Required. Please try again" Font-Size="8pt" ForeColor="Red" ValidationGroup="StudentAddStatus"></asp:RequiredFieldValidator>
                                                         <input id="txtComment"  runat="server" style="width:100%" type="text" class="form-control" placeholder="Enter status comment here..." />
                                                      </td>
                                               <td style="vertical-align:middle;width:35%">
                                       <asp:CompareValidator id="cvStudentApplicationStatus" runat="server" controltovalidate="ddlStudentApplicationStatus" errormessage="Status  is Required" operator="NotEqual" valuetocompare="Please Select Status" ValidationGroup="StudentAddStatus" ></asp:CompareValidator>
                                                   <asp:DropDownList ID="ddlStudentApplicationStatus" runat="server" CssClass="btn-outline-warning btn-fw"   DataSourceID="sdsStudentApplicationStatus" DataTextField="ApplicationStatus" DataValueField="ApplicationStatusID">
                                                       <asp:ListItem Value="0">Please Select Status</asp:ListItem>
                                                   </asp:DropDownList>
                                                   <span style="color:red">*</span>
                            <asp:SqlDataSource ID="sdsStudentApplicationStatus" runat="server" ConnectionString="<%$ ConnectionStrings:joshcoCS %>" SelectCommand="SelectStudentApplicationStatusList" SelectCommandType="StoredProcedure" >  
                           
                                <SelectParameters>
                                    <asp:SessionParameter Name="StudentApplicationID" SessionField="StudentApplicationID" Type="Int32" />
                                </SelectParameters>
                                      </asp:SqlDataSource>
                     
                                              </td>
                                              <td>
                                                  <asp:Button ID="lnkAddStatus" CssClass="btn btn-warning px-5 py-2" OnClick="lnkAddStatus_Click" ValidationGroup="StudentAddStatus"  runat="server" Text="Submit" />
                              ...
                              <tr>
                                  <td> 
                        <asp:GridView ID="gvStudentApplicationStatus" runat="server" AutoGenerateColumns="False" DataSourceID="sdsStudentApplicationStatusUpdate" CellPadding="2" CellSpacing="2" GridLines="None" Width="100%" HorizontalAlign="Left" >
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                 ...
                                 --%>       <asp:HiddenField ID="hfApplicationStatusID" Value='<%# Eval("StudentApplicationStatusUpdateID") %>' runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                            ...
                            <asp:SqlDataSource ID="sdsStudentApplicationStatusUpdate" runat="server" ConnectionString="<%$ ConnectionStrings:joshcoCS %>" SelectCommand="SelectStudentApplicationStatusUpdate" SelectCommandType="StoredProcedure" DeleteCommand="DELETE FROM Student_ApplicationStatusUpdate WHERE (StudentApplicationStatusUpdateID = @SudentApplicationStatusUpdateID)" InsertCommand="InsertStudentApplicationStatus" InsertCommandType="StoredProcedure" >
                           
                                <DeleteParameters>
                                    <asp:Parameter Name="StudentApplicationStatusUpdateID" />
                                </DeleteParameters>
                           
                                <InsertParameters>
                                    <asp:Parameter Name="Comment" Type="String" />
                                    <asp:Parameter Name="ApplicationStatusID" Type="Int32" />
                                    <asp:Parameter Name="StudentApplicationID" Type="Int32" />
                                </InsertParameters>
                ...
                <asp:SqlDataSource ID="sdsStudentApplicationProfile" runat="server" ConnectionString="<%$ ConnectionStrings:joshcoCS %>" SelectCommand="SelectStudentApplicationProfile" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:SessionParameter DefaultValue="" Name="StudentApplicationID" SessionField="StudentApplicationID" Type="Int32" />
                    </SelectParameters>
            </asp:SqlDataSource>
