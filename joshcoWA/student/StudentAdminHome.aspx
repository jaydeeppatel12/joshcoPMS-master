<%@ Page Title="" Language="C#" MasterPageFile="~/student/StudentAdmin.Master" AutoEventWireup="true" CodeBehind="StudentAdminHome.aspx.cs" Inherits="joshcoWA.student.StudentAdminHome" %>
                                            ...
                                            <div class="card" id="tbProperty" runat="server" >
                                                 <div class="card-body">
                                                    <h4 class="card-title">Properties</h4>
                                                     ...
                                                     <table  border="1">
                          <tr>
                                 <td> <asp:LinkButton ID="lblPropertyTotal" runat="server" Font-Bold="True" Font-Size="35pt" ForeColor="#005d63" Text="0" Width="100px"></asp:LinkButton></td>
                     ...
                     <table>
                          <tr>
                                                                <td style="width: 11px; text-align:right;">
                                                                     <asp:LinkButton ID="lblBedsOcuppiedTotal" runat="server" Font-Size="15pt" Text="0" Width="50px" ></asp:LinkButton>                                                              
                                ...
                                <td style="width: 5px;">&nbsp;</td>
                                                                <td style="text-align: left">
                                                                    <asp:Label ID="Label2" runat="server" Font-Size="8pt" Text="Beds Occupied" Width="75px"></asp:Label>
                                                                </td>
                                                            </tr>
                          <tr>
                                                                <td style="width: 11px; text-align:right;">
                                                                    ...
                                                                    <asp:LinkButton ID="lblVacantBedsTotal" runat="server" Font-Size="15pt" Text="0" Width="50px"></asp:LinkButton>
                                                                </td>
                                <td style="width: 5px;">&nbsp;</td>
                                                                <td style="text-align: left">
                                                                    <asp:Label ID="Label5" runat="server" Font-Size="8pt" Text="Available Beds" Width="65px"></asp:Label>
                                                                </td>
                                                            </tr>
