...
namespace joshcoWA
{
    public partial class addServiceProviderUser : System.Web.UI.UserControl
    {
        ...
        public void ClearFields()
        {
            ...
            this.ddlServiceProvider.ClearSelection();
            this.ddlServiceProvider.Enabled = true;
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (this.txtName.Value != "")
            {
                ...
                {
                    if (this.ddlServiceProvider.SelectedValue == "0")
                    {
                    ...
                    this.sdsUser.InsertParameters["UserGroupID"].DefaultValue = "3";
                    this.sdsUser.InsertParameters["UserActive"].DefaultValue = this.rblAcive.SelectedValue;
                    this.sdsUser.InsertParameters["UserPassword"].DefaultValue = this.txtRePassword.Value;
                    this.sdsUser.InsertParameters["LeaseID"].DefaultValue = this.ddlServiceProvider.SelectedValue;
                    this.sdsUser.Insert();
                ...
                else
                {
                    ...
                    this.sdsUser.UpdateParameters["UserGroupID"].DefaultValue = "3";
        ...
        protected void SendUserMail(string emailAddress, string name, string password)
        {
            ...
            string mailbody = "";
            mailbody += "A service provider user account has been created for you. Please use the following details to login to your online profile  </br></br> ";
            mailbody += "Url: <a href='http://www.quickpropsys.com/joshco/login.aspx' >Login</a> </br></br>";
            mailbody += "Username: " + emailAddress + " </br> ";
            mailbody += "Password: " + password + " </br></br> ";

            sendmail.SendMail(emailAddress, name, "Joshco: Service Provider Profile", mailbody, "");
        }
        ...
        {
            DataView dv;
            dv = (System.Data.DataView)this.sdsServiceProvider.Select(DataSourceSelectArguments.Empty);
            dv.RowFilter = "ServiceProviderID = " + this.ddlServiceProvider.SelectedValue;
            DataTable dt = new DataTable();
            dt = dv.ToTable();
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                this.txtEmailAddress.Value = dt.Rows[0]["Email"].ToString();
