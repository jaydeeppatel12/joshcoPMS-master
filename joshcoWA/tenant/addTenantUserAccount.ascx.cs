...
{
    public partial class addTenantUserAccount : System.Web.UI.UserControl
    {
        ...
        //Neccessary when you intend to update user detaiils (Not recommended in this case)
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (this.txtName.Value != "")
            {
                ...
                { //Update feature disabled for now
                ...
                Response.Redirect("tenantUserList.aspx");
            }
        }
        ...
        protected void ddlTenant_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                this.txtRePassword.Value = string.Empty;
            }           
        }
    }
}