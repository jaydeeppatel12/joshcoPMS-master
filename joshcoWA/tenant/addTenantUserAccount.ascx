<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="addTenantUserAccount.ascx.cs" Inherits="joshcoWA.tenant.addTenantUserAccount" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
   ...
   <table style="width:100%">
                                ...
                                <tr>
                                    ...
                                    </td><td style="width:300px;"><input runat="server" type="text" class="form-control py-2" placeholder="Name" id="txtName" autocomplete="off"/></td> 
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input runat="server" type="text" class="form-control py-2 " placeholder="Surname" id="txtSurname" autocomplete="off" /></td> 
                                ...
                                <tr>
                                    <td>
                                       Email Address </td><td>
                                        <input runat="server" type="text" class="form-control py-2 " placeholder="EmailAddress" id="txtEmailAddress" autocomplete="off" /></td> 
                                ...
                                <tr>
                                    ...
                                    </td><td><input runat="server" type="text" class="form-control py-2" placeholder="Contact Number" id="txtContactNumber" autocomplete="off" /></td> 
...
At least 8 characters length"  
        ...
        BackColor="#FFFF99" Font-Size="8pt" ForeColor="Red" ValidationGroup="AddP" ControlToValidate="txtPassword"></asp:RegularExpressionValidator> 
                                    ...
                                    <td style="vertical-align:top">
                                        <input runat="server"  class="form-control py-2 " type="password" pattern=".{8,12}"  placeholder="Password" id="txtPassword" autocomplete="off" />
                                    </td>
                                    <td>
                                        &nbsp;</td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <asp:CompareValidator ID="CompareValidator1" runat="server" BackColor="#FFFF99" ControlToCompare="txtPassword" ControlToValidate="txtRePassword" ErrorMessage="*password not matching" Font-Size="8pt" ForeColor="Red"></asp:CompareValidator>
                                         ...
                                         <input runat="server"  type="password" class="form-control py-2 " pattern=".{8,12}" placeholder="Password" id="txtRePassword" autocomplete="off"/>
                                                        </td> 
