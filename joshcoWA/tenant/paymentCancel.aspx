<%@ Page Title="" Language="C#" MasterPageFile="tenant.Master" AutoEventWireup="true" CodeBehind="paymentCancel.aspx.cs" Inherits="joshcoWA.tenant.paymentCancel" %>
...
<div class="form-wrap"  style="width:800px; padding:15px; margin-top:50px;"> 
    ...
    <table style="width:100%">
            <tr>
                <td>                          
                    We are sorry, you cancelled your payment transaction!  
                </td>
            </tr>                       
        </table>
        </div>
