<%@ Page Title="" Language="C#" MasterPageFile="tenant.Master" AutoEventWireup="true" CodeBehind="paymentHistory.aspx.cs" Inherits="joshcoWA.tenant.paymentHistory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2 class="mb-5">Payment History<asp:Button ID="btnPurchasePrepaidToken" runat="server" style=" vertical-align:bottom; float:right;" Text="Prepaid Electricity/Water" CssClass="btn btn-warning" PostBackUrl="purchasePrepaidToken.aspx" /></h2>
