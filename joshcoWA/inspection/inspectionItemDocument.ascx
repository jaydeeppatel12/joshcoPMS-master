<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="inspectionItemDocument.ascx.cs" Inherits="joshcoWA.inspection.inspectionItemDocument" %>
        <table style="width: 100%">
                               <tr>
                                  <td >
                                      ...
                                      <asp:FileUpload ID="flUpload" runat="server" Multiple="Multiple" CssClass="btn btn-warning" ToolTip="Upload images here"  />
                                              </td>
                                              <td>
                                                  <asp:Button ID="Button1"   OnClick="lnkUpload_Click" CssClass="btn btn-warning" runat="server" Text="Upload" />
                              ...
                              <tr>
                                  <td >
                   <asp:GridView ID="gvDocument" runat="server" AutoGenerateColumns="False" CellPadding="2" CellSpacing="3" GridLines="None" OnRowCommand="GridView2_RowCommand" style="text-align: left; font-size: 10pt;" Width="100%" DataSourceID="sdsDocument">
                                      <Columns>
