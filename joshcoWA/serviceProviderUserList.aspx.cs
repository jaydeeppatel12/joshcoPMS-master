...
namespace joshcoWA
{
    public partial class serviceProviderUserList : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "ViewUser")
            {
                ...
                ((HiddenField)this.addUser.FindControl("hfUserGroupID")).Value = "3";
                ((DropDownList)this.addUser.FindControl("ddlServiceProvider")).Enabled = false;
