<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="leaseAdd.ascx.cs" Inherits="joshcoWA.lease.leaseAdd" %>
...
ORDER BY [PropertyName]"></asp:SqlDataSource>
                                             ...
                                             <tr>
                                                 ...
                                                 <td>
                                                     <asp:DropDownList ID="ddlPropertyUnit" runat="server" DataSourceID="sdsPropertyUnit" CssClass="btn-outline-warning btn-fw" DataTextField="PropertyUnit" DataValueField="PropertyUnitID" AppendDataBoundItems="True" AutoPostBack="True" OnSelectedIndexChanged="ddlPropertyUnit_SelectedIndexChanged">
                                                         <asp:ListItem Value="0">-- Select Unit --</asp:ListItem>
                                                     </asp:DropDownList>
                                                     <asp:SqlDataSource ID="sdsPropertyUnit" runat="server" ConnectionString="<%$ ConnectionStrings:joshcoCS %>" SelectCommand="SELECT PU.* FROM [PropertyUnit]PU WHERE (PU.PropertyUnitID not in (Select L.PropertyUnitID From [dbo].[Lease]L Where L.LeaseStatus = 'Active')) and ([PropertyID] = @PropertyID) ORDER BY [PropertyUnit]">
                                                         <SelectParameters>
                                             ...
                                             <tr>
                                                 ...
                                                 <td>
                                                     <asp:TextBox ID="txtArea" runat="server" CssClass="form-control py-2" Width="100px"></asp:TextBox>
                                                 </td>
                                                 <td>&nbsp;</td>
                                             </tr>
                                             <tr>
                                                 <td class="auto-style3">
                                                     Rental Amount <span class="auto-style4">*</span><asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" BackColor="#FFFF99" ControlToValidate="txtInitialValue" Display="Dynamic" ErrorMessage="*Required" Font-Size="8pt" ForeColor="Red" ValidationGroup="App"></asp:RequiredFieldValidator>
                                                 </td>
                                                 <td>
                                             ...
                                             <tr>
                                                 <td class="auto-style3">
                                                     Escalation %<span class="auto-style4">*</span><asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" BackColor="#FFFF99" ControlToValidate="txtEscalation" Display="Dynamic" ErrorMessage="*Required" Font-Size="8pt" ForeColor="Red" ValidationGroup="App"></asp:RequiredFieldValidator>
                                                 </td>
                                                 <td>
                                             ...
                                             <tr>
                                                 ...
                                                 <td>
                                                     <asp:TextBox ID="txtInterest" runat="server" CssClass="form-control py-2" Width="100px"></asp:TextBox>
                                                 </td>
                                                 <td>&nbsp;</td>
                                             </tr>
                                             <tr>
                                                 <td class="auto-style3">Type of Lease</td>
                                                 <td>
                                             ...
                                             <tr>
                                                 <td class="auto-style3">
                                                     Rental Start Date<span class="auto-style4">*</span><asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" BackColor="#FFFF99" ControlToValidate="txtStartDate" Display="Dynamic" ErrorMessage="*Required" Font-Size="8pt" ForeColor="Red" ValidationGroup="App"></asp:RequiredFieldValidator>
                                                 </td>
                                                 <td>
            ...
            <FooterTemplate> 
                <div style="width: 100%; text-align: center; background-color: Gray;"> 
                    <input id="Basduttons1" onclick="txtStartDateToday()" type="button" value="Today" /> 
                                             ...
                                             <tr>
                                                 <td class="auto-style3">Rental Termination Date<span class="auto-style4">*</span><asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" BackColor="#FFFF99" ControlToValidate="txtEndDate" Display="Dynamic" ErrorMessage="*Required" Font-Size="8pt" ForeColor="Red" ValidationGroup="App"></asp:RequiredFieldValidator>
                                                 </td>
                                                 <td>
            ...
            <FooterTemplate> 
                <div style="width: 100%; text-align: center; background-color: Gray;"> 
                    <input id="Buttons1" onclick="txtEndDateToday()" type="button" value="Today" /> 
                </div> 
            </FooterTemplate> 
        </calendar> 
                                                    </telerik:RadDatePicker>
                                             ...
                                             <tr>
                                                 <td class="auto-style3">
                                                     Comment</td>
                                                 <td>
                                                     <asp:TextBox ID="txtComment" runat="server" CssClass="form-control py-2" Width="250px" BorderColor="#F0F0F0" Height="65px" TextMode="MultiLine"></asp:TextBox>
                                                 </td>
                                                 <td>&nbsp;</td>
                                             </tr>
                                             <tr>
                                             ...
                                             <tr>
                                                 ...
                                                 <td>   <asp:SqlDataSource ID="sdsApplication" runat="server" ConnectionString="<%$ ConnectionStrings:joshcoCS %>" InsertCommand="InsertApplicationLease" InsertCommandType="StoredProcedure" SelectCommand="Select ''" UpdateCommand="UpdateApplication" UpdateCommandType="StoredProcedure" OnInserted="sdsApplication_Inserted">
                                                     ...
                                                     <asp:Button ID="btnSubmit" runat="server"  OnClick="btnSubmit_Click" Text="Submit" CssClass="btn btn-warning px-5 py-2" ValidationGroup="App" Width="250px" />
