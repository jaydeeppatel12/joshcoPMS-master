<%@ Page Title="" Language="C#" MasterPageFile="application/admin.Master" AutoEventWireup="true" CodeBehind="leaseProfile.aspx.cs" Inherits="joshcoWA.leaseProfile" %>
...
<div class="form-wrap"  style="width:1100px"  >
    ...
    <h2>Lease Profile - <asp:Label ID="lblPropName" runat="server" Text=""></asp:Label></h2>
             <asp:Label ID="lblUnitName" runat="server" Font-Bold="true" Text=""></asp:Label><br />
...
<h3 class="heading">Lease Menu</h3>
<ul>
...
<div id="Rent" class="tabcontent" style="display:none;">
    <asp:Panel ID="pnlRent" runat="server" Width="600px" ScrollBars="Horizontal">
...
Where LeaseID = @LeaseID ">
                                  ...
                                  <td>
                                     <asp:Button ID="btnUpdateStatus" runat="server" CssClass="btn btn-primary px-5 py-2" OnClick="btnUpdateStatus_Click" Text="Submit" ValidationGroup="Dep" /></td>
