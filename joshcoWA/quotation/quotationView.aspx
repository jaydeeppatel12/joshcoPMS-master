<%@ Page Title="" Language="C#" MasterPageFile="quotation.Master" AutoEventWireup="true" CodeBehind="quotationView.aspx.cs" Inherits="joshcoWA.quotation.quotationView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <div class="col-md-8 grid-margin stretch-card">
   ...
   <h2>Invitation To Quote Details<asp:Label ID="lblCompanyName" runat="server" Text=""></asp:Label></h2>
...
ORDER BY [BusinessName]">
                                               ...
                                               <td style="vertical-align:middle; ">
                                                   ...
                                                   <asp:DropDownList ID="ddlServiceProvider" runat="server" CssClass="btn-outline-warning btn-fw" DataSourceID="sdsServiceProvider" DataTextField="BusinessName" DataValueField="ServiceProviderID">
...
Where QuotationID = @QuotationID" >
                             ...
                             <UpdateParameters>
                              ...
                              <tr>
                                  <td> 
   <asp:Panel ID="pnl" runat="server" Width="100%" ScrollBars="Horizontal">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Font-Size="10.2pt"  DataSourceID="sdsQuotation" CellPadding="2" CellSpacing="2" GridLines="None" Width="100%" HorizontalAlign="Left" OnRowCommand="GridView1_RowCommand" OnRowDataBound="GridView1_RowDataBound" >
                                        ...
                                        <asp:Panel ID="pnlUpload" Visible='<%# Convert.ToBoolean(Eval("QuoteUpload")) %>' runat="server">
                                            ...
                                            <table style="width: 100px">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Button ID="btnUpload" CausesValidation="false" CssClass="btn btn-warning"  CommandName="Upload" CommandArgument='<%# Eval("QuotationID") %>' runat="server" Text="Upload" />
                                                    </td>
                                                </tr>
                                            </table>
